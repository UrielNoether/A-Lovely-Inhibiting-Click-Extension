            ...
            tabs: [
                {
                    ...
                    load: () => {
                        ...
                        this.createText({
                            ...
                            y: 540,
                            width: 800,
                            text: "<b>1.</b> By the player who used the padlock (member number given above), or by any player who has the keys (given in the list in the Key Holders tab)."
                        });
                        ...
                        this.createText({
                            ...
                            y: 730,
                            width: 800,
                            text: "<b>2.</b> When the timer expires (if a timer is set)."
                        });
                        ...
                        this.createText({
                            ...
                            y: 830,
                            width: 800,
                            text: "<b>3.</b> When the correct code is entered (if a code is set)."
                        });
                ...
                },
                {
                    ...
                    load: () => {
                        const note = this.createInput({
                            ...
                            placeholder: "You can leave a note that other ALICE users can see",
                            isDisabled: () => !this.canEdit(),
                            onChange: () => {
