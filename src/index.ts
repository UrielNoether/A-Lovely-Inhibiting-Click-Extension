...
export function chatSendChangelog(): void {
    ...
    const text = `<div class="dogsChangelog"><b>ALICE</b> v${getModVersion()}<br><br>Changes: <ul><li>No changes, first mod version.</li><li>Hello, Alicia~</li></ul></div>`;
...
registerCore({
    name: "ALICE", //change from "DOGS"
    fullName: "A Lovely Inhibiting Click Extension", //change from "Devious Obligate Great Stuff"
    key: "ALICE", //change from "DOGS"
    version: getModVersion(),
    //repository: "https://github.com/FurryZoi/Devious-Obligate-Great-Stuff.git",
    repository: "https://github.com/UrielNoether/A-Lovely-Inhibiting-Click-Extension.git",
